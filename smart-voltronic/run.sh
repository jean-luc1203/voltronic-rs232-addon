...
# ============================================================
# Transport / host / port par onduleur
# config.json ->
#   inverter_1_transport / inverter_1_host / inverter_1_port
# ============================================================
...
# ============================================================
# Patch TCP IN/OUT host/port dans flows.json
# ============================================================
...
# En mode serial, on met une valeur neutre pour éviter NaN au boot
...
# IDs TCP à adapter à tes noeuds réels
