...
This release introduces a completely redesigned Premium Dashboard experience with modern, responsive HTML dashboards automatically generated by the add-on.

### 🏠 Smart Energy House Dashboard

The new **House Dashboard** provides a complete overview of your installation in a single page:

- Real-time energy flow visualization
- Solar production monitoring
- Battery status and SOC tracking
- Grid import/export information
- Home consumption overview
- Responsive design for desktop, tablet, and mobile devices
- Automatic integration with supported Smart Energy modules

![Smart Energy House Dashboard](docs/images/dashboard%20house.png)

### ⚡ Global Flow Dashboard

The new **Global Flow Dashboard** offers a detailed view of power flows across your energy system:
...
The new HTML dashboards are available for Premium users and can be generated automatically directly from the add-on configuration.
